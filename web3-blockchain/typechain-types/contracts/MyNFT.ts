...
export interface MyNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "marketplaceowner",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MyNFT extends BaseContract {
  ...
  marketplaceowner: TypedContractMethod<[arg0: BigNumberish], [string], "view">;

  mintNFT: TypedContractMethod<
    [to: AddressLike, uri: string, marketplace: AddressLike],
    [bigint],
    "nonpayable"
  >;
  ...
  originalowner: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "marketplaceowner"
